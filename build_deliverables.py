...
SCHEMA = [
    ...
    ("SHIPMENT", "ShipmentID", "OrderID, WarehouseID"),
]
...
def build_docx():
    ...
    bullets([
        ...
        "O3. Extend that same model into an EER model, adding specialization, a weak "
        "entity, and multivalued, composite and derived attributes.",
    ...
    d.paragraphs[-1].add_run(
        ...
        "conversion of the design into tables, the dependency analysis, and "
    ...
    figure("er_model.png", "Figure 1. ER model with 7 entities and 7 relationships")
    ...
    para("Applying these rules gives the tables that the rest of the report works "
         "on. The finished set is listed in section 10.")
    ...
    para("Eight relations come out of this decomposition. The remaining nine tables "
         "of the final design (SUPPLIER, WAREHOUSE, EMPLOYEE, MANAGER, DRIVER, "
         "PERISHABLE_PRODUCT, SUPPLIES, STOCK and SHIPMENT) come straight from the "
         "EER mapping in section 6 and were already in BCNF, because each of them "
         "has a single candidate key and no non-key determinant.")
    ...
    para("DA1 delivered an ER model of seven entities and seven relationships, the "
         ...
         "and multivalued, composite and derived attributes, a dependency analysis "
         ...
         "17 tables, all in BCNF.")
    para("DA2, due 18 September 2026: ", bold=True)
    d.paragraphs[-1].add_run(
        "create the 17 tables in SQL with their keys and constraints, load sample "
...
def build_pptx():
    ...
    bullets_slide("1. Objectives and Scope", [
        ...
        "In scope: 7 entities, namely warehouse, product, supplier, customer, "
        "orders, shipment and employee.",
    ...
    image_slide("10. Final Schema, 17 Tables, All in BCNF", img("final_schema.png"))
    ...
    bullets_slide("11. What Comes Next", [
        ...
        "  Create the 17 tables in SQL with keys and constraints, load sample data, "
    ...
    textbox(s, 0.8, 4.35, 11.7, 0.7, "7 entities, 7 relationships, 17 tables, all "
